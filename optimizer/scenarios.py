...
from optimizer.schema import CurveCols, KpiKeys, FlowCols
...
def _h_point_ssr(spec, ctx):
    from optimizer.sizing_engine import solve_sizing_point
...
def _h_curve_ssr(spec, ctx):
    from optimizer.curve_runner import run_ssr_curve
...
def _h_curve_gc(spec, ctx):
    from optimizer.curve_runner import run_peak_shaving_curve
...
def _h_sub_curve_gc(spec, ctx):
    from optimizer.curve_runner import run_sub_peak_shaving_curve
...
def _h_surface_ssr(spec, ctx):
    from optimizer.curve_runner import run_pv_bess_surface
...
def _h_co_opt(spec, ctx):
    from optimizer.curve_runner import run_co_opt_scenario
...
def _h_off_grid(spec, ctx):
    from optimizer.curve_runner import run_off_grid_curve
    import copy
...
def _h_standalone(spec, ctx):
    from optimizer.curve_runner import run_standalone_export_curve
    import copy
...
def _h_forward_eval(spec, ctx):
    ...
    """
    from optimizer.rule_dispatch import run_rule_dispatch, compute_flow_kpis, validate_flows
    pv0 = ctx.pv_mw
    no_pv = pv0 <= 1e-9
...
def _h_bound_gcmin(spec, ctx):
    from optimizer.sizing_engine import find_gc_min
...
def _h_bound_ssrmax(spec, ctx):
    from optimizer.sizing_engine import find_ssr_max
...
def _h_deliverable(spec, ctx):
    ...
    from optimizer.rule_dispatch import size_by_bisection
