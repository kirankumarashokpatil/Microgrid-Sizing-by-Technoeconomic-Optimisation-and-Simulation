...
Phase 1 usage:
  ...
  python main.py --phase1 --profiles "data/8760_PV&Load Profiles.xlsx" --pv-mw 150 --load-mw 100
...
def run_phase2(args):
    ...
    from core.economic_overlay import (
        load_phase1_curves,
        evaluate_costs,
        find_optimal_point,
        cooptimise_ssr_gc,
    ...
    from core.phase2_reporter import save_phase2_report
